...
def new_data(request):
    if request.method == 'POST':
        ...
        customer_data['service_failure_count'] = int(customer_data['service_failure_count'])
...
def existing_data(request):
    if request.method == 'POST':
        ...
        if customer_data.remaining_contract == 0:
            customer_data.contract = 0
        else:
            customer_data.contract = 1
        ...
        customer_data.subscription_age = int(customer_data.subscription_age)
        customer_data.remaining_contract = customer_data.remaining_contract * 12
        customer_data.remaining_contract = int(customer_data.remaining_contract)
        customer_data.service_failure_count = int(customer_data.service_failure_count)
        customer_data.download_over_limit = int(customer_data.download_over_limit)
